...
parser.add_argument('--epochs_encoder', type=int, default=1, help='number of epochs to train encoder.')
...
parser.add_argument('--patch_size', type=int, default=128, help='patch_size of input.')
